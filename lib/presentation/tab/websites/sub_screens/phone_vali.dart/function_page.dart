...
import 'package:arboblar_uz/presentation/tab/websites/sub_screens/phone_vali.dart/parse_model.dart';
import 'package:arboblar_uz/presentation/tab/websites/sub_screens/phone_vali.dart/region_model.dart';
import 'package:arboblar_uz/presentation/tab/websites/sub_screens/phone_vali.dart/region_picer.dart';
import 'package:arboblar_uz/presentation/tab/websites/sub_screens/phone_vali.dart/storge.dart';
import 'package:arboblar_uz/presentation/tab/websites/sub_screens/phone_vali.dart/utils.dart';
...
class FunctionsPageState extends State<FunctionsPage>
  ...
  Future<void> validate() async {
    if (key.currentState!.validate()) {
      ...
      if (isValid) {
        setState(() {
          phoneControllerMain = phoneController;
        });
      }
